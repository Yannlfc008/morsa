...
class AbstractSearcher(ABC):
    def __init__(self, search_engine: str) -> None:
        ...
        self.headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36', 'Referer': 'https://www.{search_engine}/'}
